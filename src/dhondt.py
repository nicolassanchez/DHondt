...
REVISOR: Mariano González, Fermín Cruz, José C. Riquelme, Toñi Reina
...
def calcula_diccionario_provincia(votos, provincia):
    ...
    ENTRADA: 
       - votos: lista de tuplas (provincia, partido, valor) -> [(str, str, int)]
...
def totales_por_partido(tabla_valores):
    ...
    Toma como entrada un diccionario-2D {provincia: {partido, valor}} y produce
